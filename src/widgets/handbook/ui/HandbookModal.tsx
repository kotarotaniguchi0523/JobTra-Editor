...
/**
 * HandbookModal renders only after the user opens the panel. The static RSC
 * handbook is therefore fetched on demand instead of prefetching hidden
 * content on every workspace page.
 */
export function HandbookModal({ isOpen, onClose, children }: HandbookModalProps) {
  return (
    <div
