  ...
  return (
    <div className="relative p-4 sm:p-6">
      <textarea
        ...
        rows={12}
        className="w-full resize-y text-lg sm:text-xl text-neutral-900 placeholder-neutral-300 font-sans leading-[1.75] focus:outline-hidden bg-transparent tracking-wide selection:bg-neutral-200"
        style={{ minHeight }}
      />
    </div>
  );
