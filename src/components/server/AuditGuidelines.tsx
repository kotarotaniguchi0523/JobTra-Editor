...
export function AuditGuidelines() {
  return (
    <div className="p-3.5 bg-neutral-50 rounded-lg border border-neutral-200 text-xs text-neutral-700 space-y-2.5">
      <div className="flex items-center justify-between pb-1.5 border-b border-neutral-200">
        ...
        <span className="text-xs text-neutral-400 font-mono">RSC Static Guide</span>
      </div>

      <div className="grid grid-cols-1 gap-2">
        <div className="flex items-start gap-2 bg-white/80 p-2.5 rounded">
