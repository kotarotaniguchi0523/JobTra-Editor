...
import type { DraftSnapshot, ESDraft } from '../types';
import { parseSnapshotLabel } from '../validation/schemas';
...
export const SnapshotHistory: React.FC<SnapshotHistoryProps> = memo(
  ({ draft, onSaveSnapshot, onRestoreSnapshot }) => {
